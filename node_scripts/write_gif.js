...
writeGif = function (json, done, fail) {
    ...
    if (json.binary_gif) {
        ...
        path = './collections/' + json.projectName + '/gif/';
...
exports.call = function (json, done, fail) {
    ...
    if (json.projectName) {
        ...
        // make the collections folder if not there
        mk.make('./', 'collections', function () {

            // make the folder for the project if not there
            mk.make('./collections', json.projectName, function () {

                // make the gif folder if not there
                mk.make('./collections/' + json.projectName, 'gif', function () {
